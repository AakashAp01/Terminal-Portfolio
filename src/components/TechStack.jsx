    ...
    return (
        <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-4 text-white">
                {/* HTML */}
                <div className="border border-green-500 p-4 rounded-lg bg-transparent shadow-lg flex flex-col items-center 
                hover:scale-105 transition duration-300 ease-in-out 
                animate-shine hover:drop-shadow-[0_0_10px_#22c55e]">
